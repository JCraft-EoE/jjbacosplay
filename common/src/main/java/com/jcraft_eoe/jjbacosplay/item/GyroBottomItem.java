...
public class GyroBottomItem extends ArmorItem {
    public GyroBottomItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new GyroBottomRenderer();
    ...
    private PlayState predicate(AnimationState<GyroBottomItem> animationState) {
