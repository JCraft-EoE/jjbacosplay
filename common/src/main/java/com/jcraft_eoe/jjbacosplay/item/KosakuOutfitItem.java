...
public class KosakuOutfitItem extends ArmorItem {
    public KosakuOutfitItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new KosakuArmorRenderer();
    ...
    private PlayState predicate(AnimationState<KosakuOutfitItem> animationState) {
