...
public class ValentineBottomItem extends ArmorItem {
    public ValentineBottomItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new ValentineBottomRenderer();
    ...
    private PlayState predicate(AnimationState<ValentineBottomItem> animationState) {
