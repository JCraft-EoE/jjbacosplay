...
public class FinalKiraJacketItem extends ArmorItem {
    public FinalKiraJacketItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new FinalKiraJacketRenderer();
    ...
    private PlayState predicate(AnimationState<FinalKiraJacketItem> animationState) {
