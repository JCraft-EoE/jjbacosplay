...
public class DiavoloShirtItem extends ArmorItem {
    public DiavoloShirtItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new DiavoloShirtRenderer();
    ...
    private PlayState predicate(AnimationState<DiavoloShirtItem> animationState) {
