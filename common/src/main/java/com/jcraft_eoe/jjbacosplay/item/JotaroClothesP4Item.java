...
public class JotaroClothesP4Item extends ArmorItem {
    public JotaroClothesP4Item(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new JotaroArmorP4Renderer();
    ...
    private PlayState predicate(AnimationState<JotaroClothesP4Item> animationState) {
