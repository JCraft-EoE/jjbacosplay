...
public class KakyoinClothesItem extends ArmorItem {
    public KakyoinClothesItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new KakyoinArmorRenderer();
    ...
    private PlayState predicate(AnimationState<KakyoinClothesItem> animationState) {
