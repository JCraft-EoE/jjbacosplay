...
public class GiornoClothesItem extends ArmorItem {
    public GiornoClothesItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new GiornoArmorRenderer();
    ...
    private PlayState predicate(AnimationState<GiornoClothesItem> animationState) {
