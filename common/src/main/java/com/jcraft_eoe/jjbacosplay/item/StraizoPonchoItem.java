...
public class StraizoPonchoItem extends ArmorItem {
    public StraizoPonchoItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new StraizoPonchoRenderer();
    ...
    private PlayState predicate(AnimationState<StraizoPonchoItem> animationState) {
