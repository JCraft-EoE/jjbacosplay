...
public class DiegoOutfitItem extends ArmorItem {
    public DiegoOutfitItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new DiegoOutfitRenderer();
    ...
    private PlayState predicate(AnimationState<DiegoOutfitItem> animationState) {
