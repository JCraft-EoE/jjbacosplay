...
public class ValentineTopItem extends ArmorItem {
    public ValentineTopItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new ValentineTopRenderer();
    ...
    private PlayState predicate(AnimationState<ValentineTopItem> animationState) {
