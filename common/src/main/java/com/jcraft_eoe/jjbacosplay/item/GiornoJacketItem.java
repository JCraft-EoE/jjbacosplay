...
public class GiornoJacketItem extends ArmorItem {
    public GiornoJacketItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new GiornoJacketRenderer();
    ...
    private PlayState predicate(AnimationState<GiornoJacketItem> animationState) {
