...
public class FinalKiraOutfitItem extends ArmorItem {
    public FinalKiraOutfitItem(ArmorMaterial materialIn, Type slot, Properties builder) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            @Override public @NonNull HumanoidModel<LivingEntity> getHumanoidArmorModel(
                ...
                if (renderer == null) renderer = new FinalKiraArmorRenderer();
    ...
    private PlayState predicate(AnimationState<FinalKiraOutfitItem> animationState) {
